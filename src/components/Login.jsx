      ...
      >
        ...
        <section className="relative flex items-center justify-evenly h-[100vh]">
          ...
          <p className="text-white w-[50%] text-center px-4 text-4xl font-semibold">
            Waste Link is an innovative waste disposal platform that connects
            households with waste collectors, making waste management as easy as
            booking a ride. Users can schedule waste pickups, ensuring proper
